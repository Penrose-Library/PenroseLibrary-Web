...
date_hours += year + "&";
 ...
 if (month == 0) {
 	if (date == 1) date_hours += "Penrose is closed today. Happy New Year!"; 
 	...
 	if (date == 20) date_hours += "Open at 9am<br />Closed at 9pm to non-Whitman community"; 
...
// March
 	...
 	if (date == 12) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community"; 
 	if (date == 13) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community"; 
 	if (date == 14) date_hours += "We'll be closing at 10 pm tonight."; 
 	...
 	if (date == 24) date_hours += "Penrose is open from  9am to 10pm."; 
 	if (date == 25) date_hours += "Penrose is open from  9am to 10pm."; 
 	if (date == 26) date_hours += "Penrose is open from  9am to 10pm."; 
 	if (date == 27) date_hours += "Penrose is open from  9am to 10pm."; 
 	if (date == 28) date_hours += "Penrose is open from  9am to 10pm."; 
 	if (date == 29) date_hours += "Penrose is open from  9am to 10pm.";
 	if (date == 30) date_hours += "Open at 9am<br />Closed at 10pm to non-Whitman community";
 	if (date == 31) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community";
}
 // April
else if (month == 3) {
 ...
 // May
 	...
 	if (date == 31) date_hours += "Penrose is closed today."; 
}
 // June
else if (month == 5) {
 	...
 	if (date == 5) date_hours += "Penrose is open from 9am to 5pm."; 
 	if (date == 6) date_hours += "Penrose is closed for Staff Appreciation Day."; 
 	if (date == 7) date_hours += "Penrose is closed today."; 
 	if (date == 8) date_hours += "Penrose is closed today."; 
 	if (date == 9) date_hours += "Penrose is open form 9am to 5pm."; 
 ...
 // July
 	...
 	if (date == 10) date_hours += "Penrose is open from 9am to 5pm."; 
 	if (date == 11) date_hours += "Penrose is open from 9am to 5pm."; 
 	if (date == 12) date_hours += "Penrose is closed today."; 
  ...
  // August
 	...
 	if (date == 17) date_hours += "Penrose is closed today."; 
 	if (date == 18) date_hours += "Penrose is open from 9am to 5pm."; 
 	if (date == 19) date_hours += "Penrose is open from 9am to 5pm."; 
 	if (date == 20) date_hours += "Penrose is open from 9am to 5pm."; 
 	if (date == 21) date_hours += "Penrose is open from 9am to 5pm."; 
...
// November
 	...
 	if (date == 19) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community"; 
 	if (date == 20) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community"; 
 	if (date == 21) date_hours += "Penrose will be closing at 5pm"; 
 	if (date == 22) date_hours += "Open 9am to 5pm"; 
 	...
 	if (date == 27) date_hours += "Closed"; 
 	if (date == 28) date_hours += "Closed"; 
 	if (date == 29) date_hours += "Open 1pm to 5pm";
 	if (date == 30) date_hours += "Open at 1pm<br />Closed at 9pm to non-Whitman community";
}
// December
else if (month == 11) {
 	if (date == 1) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community";
 	...
 	if (date == 17) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community"; 
 	if (date == 18) date_hours += "Open 24 hours<br />9am - 9pm to non-Whitman community"; 
 	if (date == 19) date_hours += "Penrose will close at 5pm"; 
 	if (date == 20) date_hours += "Open 9am to 5pm"; 
 	if (date == 21) date_hours += "Open 9am to 5pm"; 
 	if (date == 22) date_hours += "Penrose is closed for winter break."; 
