...
Instruction includes presentations and hands-on active learning components, as well as class discussion. You may schedule an instruction session in the Center for Teaching and Learning, college classrooms or college computer labs. Please contact Emily Pearson ([pearsome@whitman.edu](pearsome@whitman.edu); 509-527-5918), Instruction Coordinator, to schedule your session.

## Library Liaisons

Departmental liaisons are available to share information about library resources and services and discuss course-related library instruction. We are currently re-assigning our liaison assignments. For questions on the following, please do not hesitate to contact the respective librarian.

* Cataloging and book purchases: Roger Stelk (stelkre@whitman.edu)
* Course reserves, circulation, and building use: Julie Carter (carterja@whitman.edu)
* Instruction and Research Services; Archives: Emily Pearson (pearsome@whitman.edu)
* Scholarly Communications, Data, OER, and Arminda (institutional repository): Amy Blau (blauar@whitman.edu)
* General library questions: Ping Fu (fup@whitman.edu)
...
[Emily Pearson](mailto:pearsome@whitman.edu), Instruction Coordinator and Outreach Librarian (509-527-5918)
...
### How to sign-up for GOBI notifications:
...
The NSF lays out the requirements for the DMP in their [Grant Proposal Guide](https://www.nsf.gov/publications/pub_summ.jsp?ods_key=nsf17001&org=NSF). The DMP should include information explaining:
...
Some Directorates, Offices, Divisions, and Programs have specific requirements beyond those outlined above. Please check the [NSF website](https://www.nsf.gov/bfa/dias/policy/dmp.jsp) to find out whether your grant proposal will require additional components.
...
Data Services librarian [Amy Blau](mailto:blauar@whitman.edu) (509-527-4905) is available to discuss various aspects of data management. If you are planning to submit an NSF grant, please contact Rachna Sinnott (509-527-5990) or Stevie Sanchez (509) 527-5226 in the Office of Grants & Foundation Relations at least one month before the due date. They can provide guidance on grant submission procedures and compliance with College and federal requirements, including the Data Management Plan. For more information on Whitman’s policies and procedures regarding grant submission, please visit [the Grants & Foundation Relations](https://www.whitman.edu/giving/grants-and-foundation-relations) website.

## Copyright @ Whitman

We’ve put together a [guide on copyright](http://libguides.whitman.edu/copyright_ip) to help you navigate copyright in your academic and personal life, including fair use analysis tools and sample copyright request forms. The [Whitman College Copyright Policy](https://libguides.whitman.edu/copyright_ip) and procedures for use of copyrighted materials are also available.